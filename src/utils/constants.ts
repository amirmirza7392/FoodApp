export const categories = [
  ...
  },
  {
    ...
    name: 'Legume',
    image:
      'https://upload.wikimedia.org/wikipedia/commons/e/e7/Various_legumes.jpg',
  },
  {
    id: 6,
    name: 'Seafood',
  ...
  },
  {
    ...
    name: 'Poultry',
    image:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Poultry_of_the_world.jpg/1200px-Poultry_of_the_world.jpg',
  },
  {
    id: 8,
    name: 'Fish',
    image:
      'https://upload.wikimedia.org/wikipedia/commons/1/19/Fish_stuffed_with_Thai_herbs.jpg',
  },
  {
    id: 9,
    name: 'Grain',
    image:
      'https://upload.wikimedia.org/wikipedia/commons/b/be/Dhaniyangal.jpg',
  },
];
...
export const timeline = [
  {
    ...
    carbos: '47 g',
    description:
      'There\u2019s nothing like the simple things in life - the smell of freshly cut grass, sitting outside on a nice sunny day, spending time friends and family. Well here is a recipe that delivers simple culinary pleasures - some nice fresh fish a crispy crust, crunchy potato wedges and some delightfully sweet sugar snap peas flavoured cooling mint. Slip into something comfortable and relax into a delicious dinner!',
    difficulty: 0,
    fats: '8 g',
    headline: 'Sweet Potato Wedges and Minted Snap Peas',
  ...
  },
  {
    ...
    difficulty: 0,
    fats: '5 g',
    headline: 'Spinach and Lemon Couscous',
  ...
  },
  {
    ...
    difficulty: 2,
    fats: '10 g',
    headline: 'Roasted Rocket Potatoes',
  ...
  },
  {
    ...
    carbos: '84 g',
    description:
      'We\u2019ve all heard that much overused culinary phrase \u201cfusion food\u201d, but this recipe is fusion of a slightly different kind. With the onset of Winter Patrick has taken some decidedly seasonal squash and the deep, heady scent of rosemary and combined them the lighter flavour of feta and wild rice. The squash takes a little bit of work a vegetable peeler but once you\u2019ve tackled and roasted it you\u2019ll never look back. We use any leftovers for butternut squash soup!',
    difficulty: 0,
    fats: '8 g',
    headline: 'Wild Rice, Feta and Pine Nuts',
  ...
  },
  {
    ...
    difficulty: 0,
    fats: '',
    headline: 'Toasted Pine Nuts and Tenderstem Broccoli',
  ...
  },
  {
    ...
    difficulty: 3,
    fats: '9 g',
    headline: 'Creamy Parmesan Polenta',
  ...
  },
  {
    ...
    carbos: '62 g',
    description:
      'Patrick has been working on a theory that the fewer utensils you use to eat a meal, the tastier it\u2019s likely to be. Think about it - everything you eat only a fork is usually delicious. Dispense cutlery entirely to use your fingers and suddenly you\u2019re in taste bud paradise. That was the thinking behind this Japanese favourite. A surefire winner in the eateries of Tokyo, pick it up your fingers and get stuck in! The first person to finish has to shout \u201cBanzaaaiiii\u201d!',
    difficulty: 2,
    fats: '4 g',
    ...
    name: 'Genki Yakitori Crispy Red Onions',
    proteins: '32 g',
    thumb:
